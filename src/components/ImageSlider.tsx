...
//             className={`absolute w-full h-full rounded-2xl bg-center bg-cover transition-transform duration-500 ease-in-out bg-top
//               ${slideDirection === "left"
...
//               className={`absolute w-full h-full rounded-2xl bg-center bg-cover transition-transform duration-500 ease-in-out bg-top ${slideDirection === "left"
...
const ImageSlider = () => {
  ...
  const getSlideStyle = (index: number) => ({
    backgroundImage: `url(${slides[index].url})`,
    backgroundPosition: "50% 10%",
    display: loadedImages.has(slides[index].url) ? "block" : "none", // Display only if image is loaded
  });
    ...
    <>
      ...
      <div className="max-w-[1400px] h-[700px] h-[95vh] w-full m-auto py-8 px-4 relative group overflow-hidden">
        <div className="relative w-full h-full rounded-2xl">
          <div
            style={getSlideStyle(currentIndex)}
            className={`absolute w-full h-full rounded-2xl bg-center bg-cover transition-transform duration-500 ease-in-out bg-top ${slideDirection === "left" ? "animate-slide-out-left" : ""
          ...
          {slideDirection && (
            <div
              style={getSlideStyle(nextIndex)}
              className={`absolute w-full h-full rounded-2xl bg-center bg-cover transition-transform duration-500 ease-in-out bg-top ${slideDirection === "left" ? "animate-slide-in-left" : ""
